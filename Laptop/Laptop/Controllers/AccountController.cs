    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Sai tài khoản hoặc mật khẩu."); // Nếu đăng nhập sai
                }
            }

            // Nếu nhập sai yêu cầu thì ở lại trang Đăng nhập
            return View(model);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string url = Request.Url.AbsoluteUri.Replace("Register", "Active?userName=" + model.UserName);
